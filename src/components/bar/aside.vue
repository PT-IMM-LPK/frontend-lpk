...
import { XMarkIcon, ChevronRightIcon, ChartBarIcon, QuestionMarkCircleIcon, BuildingLibraryIcon, ChevronDownIcon, CheckIcon, InboxStackIcon, UserIcon, ArrowRightStartOnRectangleIcon } from '@heroicons/vue/24/outline'
...
const menuItems = [
  ...
  { id: 'kelola-pertanyaan', label: 'Kelola Pertanyaan', icon: QuestionMarkCircleIcon },
  { 
    id: 'master-data', 
    label: 'Master Data',
...
<template>
  ...
  >
    <!-- Header -->
    <div class="px-3 sm:px-5 py-3 sm:py-4 border-b border-gray-200 flex items-center justify-between">
      <img src="/image_asset/IMM.svg" alt="Logo P2H" class="h-8 sm:h-9 w-auto mx-auto" />
      <button 
        @click="isMobileMenuOpen = false"
